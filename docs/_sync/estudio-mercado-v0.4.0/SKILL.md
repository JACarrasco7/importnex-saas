...
> **El informe debe usar SIEMPRE una cifra redonda de 1.500 € de gastos fijos** para calcular el **"Puesto en Huelva"** y el **"Ahorro real"** en las tablas y resúmenes. Esta es la cifra que el usuario ve y con la que decide — no el cálculo técnico del `hueco_neto_pct`.
>
> **De dónde salen esos 1.500 €** (corregido 12-sep-2026): son los **1.129 € reales**
> documentados en `importacion-vehiculos/04-negocio/costes.md` (transporte 900 +
> ausfuhr 114 + ITV importación 115) **más ~371 € de colchón** para imprevistos. NO es
> un desglose alternativo: antes esta sección decía "1.000 transporte + 200 ITV + 300
> gestoría", componentes que no existen en ninguna fuente. **Fuente única siempre
> `costes.md`** — si esa cifra cambia, cambia aquí.
>
> **Por qué una cifra redonda:** el estudio de mercado mira precios de compra. El IEDMT
> es variable (CO₂, año). Para decidir si merece la pena importar un modelo basta una
> cifra redonda con colchón. Cuando hay unidad concreta (Flujo A) se calcula el **IEDMT**
> exacto.
>
> **Fórmula:**
...
>
> **El IEDMT NO se incluye** en el informe de estudio. Se menciona en la sección
> "💶 DESGLOSE DE LOS 1.500 € DE GASTOS FIJOS" para que el usuario sepa qué falta.

### 🚫 IVA: NO se suma nunca en una compra intracomunitaria (12-sep-2026)

> **Un usado comprado en Alemania NO vuelve a tributar IVA en España.** No existe
> "valor en aduana" en una compra intracomunitaria — esa es terminología de
> importación de terceros países (EEUU, UK, Japón).
>
> Esta skill afirmaba lo contrario ("21 % sobre el valor en aduana… como particular se
> paga"). Es el **mismo fallo** que se detectó y eliminó el 12-sep-2026 de
> `PrecioClienteCalculator.php` en el panel, donde inflaba el precio del cliente unos
> **6.700 € en un coche de 32.000 €**. Aquí era peor: un 21 % fantasma en el coste de
> importación **hunde el `hueco_neto_pct` y mata modelos que sí son rentables**, que es
> exactamente la decisión que esta skill existe para tomar.
>
> Regla correcta (`04-negocio/costes.md` §IVA):
> - **Particular sin NIF-IVA (caso normal del cliente):** paga el precio alemán con el
>   IVA alemán ya dentro. **NO paga IVA español. Nunca sumar 21 %.**
> - **Empresa con NIF-IVA intracomunitario:** paga el precio sin IVA alemán y liquida el
>   21 % español (modelo 309), que después deduce.
> - **Única excepción — regla 6/6000:** si el coche tiene **<6 meses O <6.000 km**, sí se
>   liquida el 21 % español aunque sea usado. Si un modelo se mide con unidades casi
>   nuevas, **declararlo en el informe** en vez de ignorarlo.

### 📊 Horquilla, no cifra cerrada (12-sep-2026, alineado con v3.9.1 de la skill hermana)

> El "Puesto en Huelva" y el "Ahorro real" son **estimaciones**, y presentarlos al euro
> ("te ahorras 7.701 €") da una falsa precisión que la skill hermana ya eliminó en su
> ficha de cliente. En el informe de mercado:
> - **Redondear a la centena** ("≈21.200 €", "ahorro ≈7.700 €"), nunca al euro.
> - Cuando el IEDMT no está estimado, decir **"sin IEDMT"** junto a la cifra, no dejarla
>   suelta como si fuera el total.
> - El `hueco_neto_pct` del JSON sí conserva los decimales — es cálculo interno, no
>   texto que el usuario lea como promesa.
>
