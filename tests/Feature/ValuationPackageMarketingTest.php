...
TXT;
        ...
        $fb1 = CarMarketingContent::where('car_id', $result['car']->id)
            ...
            ->where('slot', 1)
            ->first();
        $this->assertNotNull($fb1);
        $this->assertStringContainsString('• 306 CV', $fb1->description);
        $this->assertStringContainsString('• Cambio automático', $fb1->description);
    }
}
