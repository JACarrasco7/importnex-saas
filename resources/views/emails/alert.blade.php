        ...
        <div style="padding: 30px;">
            ...
            @if ($alertUrl)
                <div style="text-align: center; margin: 30px 0;">
                    <a href="{{ $alertUrl }}" style="display: inline-block; padding: 12px 30px; background: #1A306D; color: #ffffff; text-decoration: none; border-radius: 6px; font-weight: 600; font-size: 15px;">
                        {{ __('Ver detalles') }}
                    </a>
                </div>
            @endif
