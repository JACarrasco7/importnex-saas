            ...
            <div class="overflow-hidden rounded-2xl bg-white shadow-xl ring-1 ring-gray-200">
                <div class="px-8 py-12 text-center">
                    <div class="mx-auto mb-6 flex h-20 w-20 items-center justify-center rounded-full bg-estoril-100">
                        <CheckCircleIcon class="h-12 w-12 text-estoril-700" />
                    </div>
                    ...
                    <p class="mt-4 text-sm font-semibold uppercase tracking-wider text-gray-500">
                        {{ organization.name }}
                    </p>
                </div>
                    ...
                    <div class="space-y-4">
                        <div class="flex items-start gap-3">
                            <div class="rounded-lg bg-estoril-100 p-2">
                                <TruckIcon class="h-5 w-5 text-estoril-700" />
                            </div>
                            <div>
                        ...
                        <div class="flex items-start gap-3">
                            <div class="rounded-lg bg-estoril-100 p-2">
                                <PhoneIcon class="h-5 w-5 text-estoril-700" />
                            </div>
                            <div>
                        ...
                        <div class="flex items-start gap-3">
                            <div class="rounded-lg bg-estoril-100 p-2">
                                <EnvelopeIcon class="h-5 w-5 text-estoril-700" />
                            </div>
                            <div>
                ...
                <div class="border-t border-gray-200 px-8 py-6 text-center">
                    <Link
                        :href="route('public.car-request.index', organization.slug)"
                        class="inline-flex items-center gap-2 rounded-lg bg-estoril-700 px-6 py-2 text-sm font-semibold text-white shadow-sm hover:bg-estoril-800"
                    >
