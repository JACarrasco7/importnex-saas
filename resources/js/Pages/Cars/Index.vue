            ...
            <div class="mx-auto max-w-7xl space-y-6 px-4 sm:px-6 lg:px-8">
                <PageHeader :title="t('nav.inventory')" :subtitle="t('app.inventory_count', { count: props.cars?.total || 0 })">
                    <template #actions>
                        ...
                        <Link :href="route('cars.create')" prefetch="hover" class="inline-flex items-center gap-2 rounded-lg bg-estoril-600 px-4 py-2 text-sm font-semibold text-white shadow-sm hover:bg-estoril-500">
