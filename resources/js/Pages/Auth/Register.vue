...
<template>
    ...
    <GuestLayout>
        <div class="mb-8">
            ...
            <p class="mt-1 text-sm text-gray-600">Start your 14-day free trial</p>
        </div>
        ...
        <form @submit.prevent="submit" class="space-y-5">
            ...
            <p class="text-center text-sm text-gray-600">
                ...
                <Link :href="route('login')" class="font-semibold text-indigo-600 hover:text-indigo-500">Sign in</Link>
            </p>
        </form>
    </GuestLayout>
</template>
