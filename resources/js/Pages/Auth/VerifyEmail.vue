...
<template>
    ...
    <GuestLayout>
        <div class="mb-8">
            <div class="mx-auto mb-4 flex h-12 w-12 items-center justify-center rounded-xl bg-indigo-50">
                <EnvelopeIcon class="h-6 w-6 text-indigo-600" />
            </div>
            <h2 class="text-center text-2xl font-bold text-gray-900">Verify your email</h2>
            <p class="mt-2 text-center text-sm text-gray-600">Thanks for signing up! Before getting started, please verify your email by clicking the link we sent you.</p>
        </div>
