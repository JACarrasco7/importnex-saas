...
class CarDocument extends Model
{
    ...
    // used for one-off AI-generated PDFs generated by Laravel (informe-interno, ficha, folleto).
    // NOT related to the briefing PDF that was removed from the ecosystem.
